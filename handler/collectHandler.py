...
class CollectHandler(BaseHandler):
    ...
    def get(self, subtype):
        ...
        if r[0]:
            ...
            return self.render("space/collect.html", vlist=r[1], vinfo=r[2], subtype=subtype, params=json.dumps(params), f=params, vurl='/collect/'+subtype.lower()+'/', vparams=self._build_params(params))
        else:
