...
KEditor.prototype = {
	...
	create : function() {
		...
		statusbar.removeClass('statusbar').addClass('ke-statusbar')
			.append('<span style="display:none;" class="ke-inline-block ke-statusbar-center-icon"></span>')
			.append('<span style="display:none;" class="ke-inline-block ke-statusbar-right-icon"></span>');
...
function _create(expr, options) {
	...
	if (_undef(options.loadStyleMode, K.options.loadStyleMode)) {
		...
		_loadStyle(options.staticPath + 'css/kindeditor.css');
