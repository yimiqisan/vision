(function(b) {
    ...
    a.iNote = (function() {
        ...
        function n(u, v, w) {
            ...
            z = b('<li id="pic'+pic_num+'" itemid="pic'+pic_num+'" class="span8 box" style="cursor:move;"><div class="thumbnail" style="min-height:100px;"><input type="radio" name="cover" value="'+pic_num+'" onclick="yhui.iNote.cover(this);return false;" style="float:left;margin:5px;"><div style="float:left; clear:right;margin-right:10px;"><img src="/image/attach/'+v+'" alt="" title="" style="width:100px;height:100px;margin-bottom:5px;" width="100" height="100"><input name="'+pic_num+'PIC" type="hidden" value="'+v+'" /></div><div id="'+pic_num+'View" class="view">'+w+'</div><a class="close" rel="'+pic_num+'" href="#" onclick="yhui.iNote.delPic(this);return false;">×</a></div></li><textarea id="'+pic_num+'Edit" name="'+pic_num+'Edit" class="inplace">'+w+'</textarea>');
